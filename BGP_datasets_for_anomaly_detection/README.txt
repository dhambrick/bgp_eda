BGP_datasets_for_anomaly_detection_csv.zip
----------------------------------------------------------------------
...
Description: 
Three well-known Boarder Gateway Anomalies (BGP) anomalies Slammer, Nimda, and Code Red I occurred in January 2003, September 2001, and July 2001, respectively. The Reseaux IP Europeens (RIPE) BGP update messages are publicly available from the Network Coordination Centre (NCC)
...
37 features are extracted from BGP update messages that originated from AS 513 (route collector rrc 04). The data collected during periods of Internet anomalies include five-day periods: the day of the attack as well as two days prior and two days after the attack.
...
Columns 1-37: features
Column 38: labels for the regular (-1) and anomalous (1) data.
